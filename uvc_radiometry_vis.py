        ...
        try:
            ...
            try:
                while True:
                    ...
                    img_flir = raw_to_8bit(data)
                    img_amg = raw_to_8bit(AMG_Numpy)
                    img_amg = np.rot90(np.rot90(img_amg))

                    print(img_flir)
                    print(img_amg)
                    cv2.imshow('FLIR', img_flir)
                    cv2.imshow('AMG', img_amg)
                    cv2.waitKey(1)

                    save_pairs([img_flir, img_amg], "paired_images", counter)
                    counter += 1
